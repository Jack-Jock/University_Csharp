...
namespace University3
{
    ...
    public class Teacher : Human
    {
        ...
        public Teacher(string name, string surname, int age, double height,
            double weight, bool habbits, Nation nation, Address address, string email, int salary, string department, KeyWords keyWords, int numofseats) : base(name, surname,
                age, height, weight, habbits, nation, address, email)
        {
            this.salary = salary;
